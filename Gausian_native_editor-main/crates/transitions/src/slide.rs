...
impl SlideTransition {
    ...
    fn ensure_pipeline(&mut self, device: &wgpu::Device) {
        ...
        let uniform_bind_group_layout =
            device.create_bind_group_layout(&wgpu::BindGroupLayoutDescriptor {
                label: Some("Slide Uniform Bind Group Layout"),
...
impl Transition for SlideTransition {
    ...
    fn render(
        ...
        let (offset_x, offset_y) = self.offset_vec();

        let uniform_data = [progress, offset_x, offset_y, 0.0];
        let uniform_buffer = device.create_buffer_init(&wgpu::util::BufferInitDescriptor {
            label: Some("Slide Uniforms"),
        ...
        let texture_bind_group = device.create_bind_group(&wgpu::BindGroupDescriptor {
            label: Some("Slide Texture Bind Group"),
        ...
        let uniform_bind_group = device.create_bind_group(&wgpu::BindGroupDescriptor {
            label: Some("Slide Uniform Bind Group"),
