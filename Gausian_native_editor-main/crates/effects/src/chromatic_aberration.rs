    ...
    fn ensure_pipeline(&mut self, device: &wgpu::Device) {
        ...
        let texture_bind_group_layout =
            device.create_bind_group_layout(&wgpu::BindGroupLayoutDescriptor {
                label: Some("Chromatic Aberration Texture Bind Group Layout"),
                entries: &[
        ...
        let uniform_bind_group_layout =
            device.create_bind_group_layout(&wgpu::BindGroupLayoutDescriptor {
                label: Some("Chromatic Aberration Uniform Bind Group Layout"),
...
impl Effect for ChromaticAberrationEffect {
    ...
    fn parameters(&self) -> Vec<EffectParameter> {
        vec![
            EffectParameter {
                ...
                min: 0.0,
                max: 50.0,
                description: "Aberration strength in pixels".to_string(),
            },
            EffectParameter {
                ...
                min: 0.0,
                max: 1.0,
                description: "Aberration center X (0-1)".to_string(),
            },
            EffectParameter {
                ...
                min: 0.0,
                max: 1.0,
                description: "Aberration center Y (0-1)".to_string(),
            },
        ]
    }
    ...
    fn apply(
        ...
        let center_x = self.get_param(params, "center_x");
        let center_y = self.get_param(params, "center_y");

        let uniform_data = [strength, center_x, center_y, 0.0];
        ...
        let texture_bind_group = device.create_bind_group(&wgpu::BindGroupDescriptor {
            label: Some("Chromatic Aberration Texture Bind Group"),
        ...
        let uniform_bind_group = device.create_bind_group(&wgpu::BindGroupDescriptor {
            label: Some("Chromatic Aberration Uniform Bind Group"),
        ...
        let mut encoder = device.create_command_encoder(&wgpu::CommandEncoderDescriptor {
            label: Some("Chromatic Aberration Encoder"),
        });

        {
            let mut render_pass = encoder.begin_render_pass(&wgpu::RenderPassDescriptor {
                label: Some("Chromatic Aberration Render Pass"),
